...
<div class="container my-3">
    ...
    <form method="post" action="/sewa/editkamar/proses/{{$title}}">
    @csrf
    <div class="w-50">
    <div class="mb-3">
        ...
        <input type="datetime-local" class="" name="check_in" value="{{$sk->check_in}}">
        

        <label for="exampleInputEmail1" class="form-label">Check out</label>
        <input type="datetime-local" class="" name="check_out" value="{{$sk->check_out}}">
        
        <br>
        <p>Harga sewa kamar saat ini : {{$sk->harga}}</p>
